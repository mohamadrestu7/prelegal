...
function FilledField({
  ...
  if (!value.trim()) {
    return (
      <span className="text-gray-400 italic print:text-black">[{placeholder}]</span>
    );
  }
        ...
        <div className="border border-gray-300 p-6 space-y-5 text-sm">
          ...
          <section>
            ...
            {effectiveDateDisplay ? (
              ...
              <p className="text-gray-400 italic print:text-black">
                [Today&apos;s date]
              </p>
            )}
          </section>
          ...
          <section>
            ...
            <p className="flex items-start gap-1">
              ...
              {data.mndaTermType === "fixed" ? (
                <>
                  Expires <strong>{mndaTermYearsLabel}</strong> from Effective
                  Date.
                </>
              ) : (
          ...
          <section>
            ...
            <p className="flex items-start gap-1">
              ...
              {data.confidentialityTermType === "fixed" ? (
                <>
                  <strong>{confidentialityYearsLabel}</strong> from Effective
                  Date, but in the case of trade secrets until Confidential
                  Information is no longer considered a trade secret under
                  applicable laws.
                </>
              ) : (
                <span className="text-gray-500">
                  {confidentialityYearsLabel} from Effective Date, but in the
                  case of trade secrets until Confidential Information is no
      ...
      <div>
        ...
        <ol className="space-y-4 list-none">
          <li>
            ...
            Page (defined below)) (&ldquo;<strong>MNDA</strong>&rdquo;) allows
            each party (&ldquo;<strong>Disclosing Party</strong>&rdquo;) to
            disclose or make available information in connection with the{" "}
            <CoverpageRef>Purpose</CoverpageRef> which (1) the Disclosing Party
            identifies to the receiving party (&ldquo;
            <strong>Receiving Party</strong>&rdquo;) as &ldquo;confidential
            &rdquo;, &ldquo;proprietary&rdquo;, or the like or (2) should be
            reasonably understood as confidential or proprietary due to its
            nature and the circumstances of its disclosure (&ldquo;
            <strong>Confidential Information</strong>&rdquo;). Each party
            &rsquo;s Confidential Information also includes the existence and
            status of the parties&rsquo; discussions and information on the
            Cover Page. Confidential Information includes technical or business
            ...
            know-how. To use this MNDA, the parties must complete and sign a
            cover page incorporating these Standard Terms (&ldquo;
            <strong>Cover Page</strong>&rdquo;). Each party is identified on the
            Cover Page and capitalized terms have the meanings given herein or
            on the Cover Page.
          </li>
          <li>
            ...
            for the <CoverpageRef>Purpose</CoverpageRef>; (b) not disclose
            ...
            reasonable need to know for the <CoverpageRef>Purpose</CoverpageRef>
          ...
          <li>
            ...
            disclosure and reasonably cooperates, at the Disclosing Party
            &rsquo;s expense, with the Disclosing Party&rsquo;s efforts to
          ...
          <li>
            ...
            the <CoverpageRef>Effective Date</CoverpageRef> and expires at the
            end of the <CoverpageRef>MNDA Term</CoverpageRef>. Either party may
            terminate this MNDA for any or no reason upon written notice to the
            other party. The Receiving Party&rsquo;s obligations relating to
            Confidential Information will survive for the{" "}
            <CoverpageRef>Term of Confidentiality</CoverpageRef>, despite any
          ...
          <li>
            ...
            in the Receiving Party&rsquo;s possession or control or return it
            to the Disclosing Party; and (c) if requested by the Disclosing
            Party, confirm its compliance with these obligations in writing. As
            an exception to subsection (b), the Receiving Party may retain
          ...
          <li>
            ...
            <CoverpageRef>Governing Law</CoverpageRef>, without regard to the
            conflict of laws provisions of such{" "}
            <CoverpageRef>Governing Law</CoverpageRef>. Any legal suit, action,
            or proceeding relating to this MNDA must be instituted in the
            federal or state courts located in{" "}
            <CoverpageRef>Jurisdiction</CoverpageRef>. Each party irrevocably
            submits to the exclusive jurisdiction of such{" "}
            <CoverpageRef>Jurisdiction</CoverpageRef> in any such suit, action,
            or proceeding.
          </li>
          <li>
            ...
            Party is entitled to seek appropriate equitable relief, including an
          ...
          <li>
            ...
            substantially all its assets or voting securities. Any assignment in
            violation of this Section is null and void. This MNDA will bind and
            inure to the benefit of each party&rsquo;s permitted successors and
            assigns. Waivers must be signed by the waiving party&rsquo;s
            authorized representative and cannot be implied from conduct. If any
            provision of this MNDA is held unenforceable, it will be limited to
            the minimum extent necessary so the rest of this MNDA remains in
            effect. This MNDA (including the Cover Page) constitutes the entire
            ...
            parties. Notices, requests and approvals under this MNDA must be
            sent in writing to the email or postal addresses on the Cover Page
            and are deemed delivered on receipt. This MNDA may be executed in
            counterparts, including electronic copies, each of which is deemed
            an original and which together form the same agreement.
          </li>
        </ol>
